sap.ui.define(
    ...
    function (Controller, History, JSONModel, Fragment, Log, MessageBox) {
      ...
      return Controller.extend("at.clouddna.lagerverwaltung.controller.LagerorteDetails", {
        _fragmentList: {},
        bCreate: false,
        ...
        _setFragement: function (sFragmentName) {
          let oPage = this.getView().byId("lagerungen_page");
        ...
        onNavBack: function () {
          ...
          if (sPreviousHash !== undefined) {
            ...
            oRouter.navTo("LagerorteDetails");
          }
        },
        ...
        _toggleEdit: function (bEditMode) {
          ...
          this._showCustomerFragment(bEditMode ? "LagerortBearbeiten" : "LagerorteDetails");
        },
         ...
         onSavePressed: function () {
          ...
          if(this.bCreate){
            ...
            let oListBinding=oModel.bindList("/Lagerort");
